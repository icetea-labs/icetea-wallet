            ...
            <div className='sc-gojNiO eOBWdQ'>
              ...
              <div className='sc-bXGyLb flEHgi'>
                <div className='sc-eLExRp OsgFE'>
                  <div className='sc-cbkKFq BDdrA' />
                  <div className='sc-cbkKFq cMpCTv' />
                </div>
                <div>
                  <div>
              ...
              <div className='sc-lkqHmb jPpgi'><i className='fa fa-times dJRkzW' aria-hidden='true' onClick={() => this.props.closePoup()} />
              </div>
