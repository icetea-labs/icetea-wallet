...
export const WrapperHeader = styled.div`
  ...
  height:40px;padding:0 5px 0 15px;
`;
export const WrapperCalender = styled(DivSelectWordBase)`
  ...
  .react-calendar__navigation button[disabled],.react-calendar__month-view button.react-calendar__tile:disabled{
  ...
  .react-calendar__navigation button:enabled:focus,.react-calendar__tile:enabled:focus{
    background-color:${props => props.theme.dropdownBg };
  }
  .react-calendar__tile:enabled:hover,.react-calendar__navigation button:enabled:hover{
...
export const WrapperTextFullHistory = styled.div`
  color:#212833;
  font-size:12px;
  a{color:#F0B90B;margin-left:3px;}
`;
...
export const TypeTranfer = styled.div`
  color:${props => "IN" === props.type ? "#00c087" : "#ea0070"};
  background:${props => "IN" === props.type ? "rgba(0, 192, 135, 0.1)" : "rgba(234, 0, 112, 0.1)"};
  position:absolute;
  left:85px;top:8px;height:24px;
  line-height:25px;
  text-align:center;
  text-indent:0;
  width:40px;
...
export const TypeOrder = styled.div`
  color:${props => "BUY" === props.type ? "#00c087" : "#ea0070"};
  background:${props => "BUY" === props.type ? "rgba(0, 192, 135, 0.1)" : "rgba(234, 0, 112, 0.1)"};
