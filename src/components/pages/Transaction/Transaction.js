  ...
  menu = () => (
    <Menu onSelect={this.onSelect}>
      <MenuItem key='0' disabled className='search-box' >
        <i className='fa fa-search iiYHFz' aria-hidden='true' size='16' />
          ...
          <div className='sc-iVOTot kWvvtK' >
            ...
            <div className='sc-hZhUor hQTvNh'>
              <div className='sc-iysEgW kOhtc'>
                <div className='sc-fxgLge cDKtWs' />
                <div className='sc-fxgLge ibjfRk' />
              </div>
              <div>
                <div>
                  <div className='sc-eTyWNx hoKJiD'>
                    ...
                    <div width='100%' className='select  sc-dHmInP iBVLYA'>
                      <div>
                        ...
                        <i className='sc-hZSUBg kpQUwp' onClick={() => this.menu} />
                      </div>
                    </div>
                  </div>
                  <div className='sc-eTyWNx hoKJiD'>
                  ...
                  <div className='sc-eTyWNx hoKJiD'>
                    ...
                    <textarea className='textarea' name='memo' onChange={this.handleChange} />
                  </div>
            ...
            <div className='sc-lkqHmb jPpgi'>
              <i className='fa fa-times dJRkzW' aria-hidden='true' onClick={() => this.props.closePoup()} /></div>
          </div>
        </div>
      </div>
    )
