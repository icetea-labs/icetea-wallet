...
class AccoutMenu extends Component {
  ...
  showAccount = () => {
    const account = listAccount.map((item, index) => {
      const className =
        index === this.state.selectedAccount
          ? 'account-menu__check-mark checked'
          : 'account-menu__check-mark';
      return (
        <div
          className="account-menu__account menu__item--clickable"
          key={index}
          onClick={() => this.setSelectedAccount(index)}
        >
      ...
      <div className="account-wrapper">
        ...
        <div className="menu account-menu">
          ...
          <div className="account-menu__accounts-container">
            <div className="account-menu__accounts">{this.showAccount()}</div>
          </div>
          <div className="menu__divider" />
