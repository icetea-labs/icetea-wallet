...
export class Table extends PureComponent {
  ...
  handleHeadClick = (e) => {
    ...
    if (this.props.sort) {
      ...
      this.setState({
        sortType: "sort_asc" === sortType ? "sort_desc" : "sort_asc"
      });
    }
  }
  ...
  _renderTitle = (e) => {
    return "string" === e.type ? <span>{e}</span> : e
  }
  _renderHeaderDetails = (e, t) => {
    return this._renderTitle(e); //[, <O><Icon type={t}/></O> ]
  }
  _renderHeader = (e, t, n) => {
    return "left" === e ? <HeaderLeft>{this._renderHeaderDetails(t, n)}</HeaderLeft> : "center" === e ? <HeaderCenter>{this._renderHeaderDetails(t, n)}</HeaderCenter> : <HeaderRight>{this._renderHeaderDetails(t, n)}</HeaderRight>
  }
  render() {
